package com.hyekyoung.batchstudy.batchfire.biz.erp.IF_ERP_SF_0004.job;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.dataformat.xml.XmlMapper;
import com.hyekyoung.batchstudy.batchfire.biz.erp.IF_ERP_SF_0004.dto.RTDataDto;
...
@Slf4j
@Configuration
public class IF_ERP_SF_0004JobConfiguration extends AbstractCommonJobConfiguration<RTDataDto> {
    protected IF_ERP_SF_0004JobConfiguration(
    ...
    private final String jobName = "IF_ERP_SF_0004";
    private final String interfaceId = "IF_ERP_SF_0004";
     ...
     * @return IF_ERP_SF_0004JobReader
     */
    @Bean(jobName + readerSuffix)
    @Override
    public ItemReader<RTDataDto> createReader() {
        return new IF_ERP_SF_0004JobReader(mappingProperties.get(interfaceId), connectManagers, objectMapper, xmlMapper, modelMapper);
    }
     ...
     * connectManagers: Interface Connector
     * objectMapper, xmlMapper, modelMapper: Data Convertor
     * @return IF_ERP_SF_0004JobWriter
     */
    @Bean(jobName + writerSuffix)
    @Override
    public ItemWriter<RTDataDto> createWriter() {
        return new IF_ERP_SF_0004JobWriter(mappingProperties.get(interfaceId), connectManagers, objectMapper, xmlMapper, modelMapper);
    }
}
